...
mal_images = glob('skin_cancer/data/train/malignant/*')
ben_images = glob('skin_cancer/data/train/benign/*')

#Also, we assign just five images to display how data looks like.

mal_images_1 = glob('skin_cancer/data/train/malignant/*')[:5]
ben_images_1 = glob('skin_cancer/data/train/benign/*')[:5]
